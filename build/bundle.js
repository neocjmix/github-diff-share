...
var _decorators = __webpack_require__(308);
...
var _prismjs = __webpack_require__(324);

var _prismjs2 = _interopRequireDefault(_prismjs);

var _parseDiff = __webpack_require__(323);

var _parseDiff2 = _interopRequireDefault(_parseDiff);

var _limitRate = __webpack_require__(122);

var _limitRate2 = _interopRequireDefault(_limitRate);

var _props = __webpack_require__(121);
...
var eUrlInput = document.getElementById('url');
var eContentDiv = document.getElementById('content');
var twicePerSecond = (0, _limitRate2.default)(500);
var selectLanguages = function (languagesMap) {
    return function (extension) {
        var matchingLanguages = Object.entries(languagesMap).filter(function (entry) {
            return entry[1].includes(extension);
        }).map(function (entry) {
            return entry[0];
        });

        return _prismjs2.default.languages[matchingLanguages.length > 0 ? matchingLanguages[0] : "clike"];
    };
}(_props2.default.languages);
...
function formatChunks(files) {
    return files.map(function (file) {
        return Object.assign({}, file, {
            chunks: file.chunks.map(function (chunk) {
                var code = chunk.changes.map(function (change) {
                ...
                return Object.assign({}, chunk, {
                    changes: _prismjs2.default.highlight(code, selectLanguages(file.to.match("(\\.)([^\\.]*$)")[2])).split('\n').map(function (line, index) {
                        return Object.assign({}, chunk.changes[index], {
                            content: line
                        });
                    })
                });
...
function setChunkUi(eChunk) {
    eChunk.addEventListener('change', function (e) {
        return eChunk.dataset.status = eChunk.querySelector('.ui input:checked').value;
    });
}
...
function changeUrl(inputElement) {
    var url = inputElement.value.replace(/(.diff)?$/, ".diff");
    if (!setInputValidity(inputElement, isValidGithubCommitDiffUrl(url))) return;

    twicePerSecond(function () {
        history.replaceState({}, "", "?url=" + url);
        loadPageViaProxyServer(url, "https://crossorigin.me").then(_parseDiff2.default).then(formatChunks).then(_file2.default).then(function (html) {
...
eUrlInput.addEventListener('input', function (e) {
    return changeUrl(e.target);
});
...
module.exports = {
	"languages": {
		"javascript": ["js", "coffee", "json"],
		"css": ["css", "less", "sass"],
		"markup": ["html", "htm", "hbs", "ftl", "vm", "xml"]
	}
};
...
// module
exports.push([module.i, "ul {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\nbody {\n  margin: 0;\n  background: #ddd;\n}\nbody .container {\n  margin: 0 auto;\n  max-width: 960px;\n  padding: 2em;\n  background: white;\n}\nbody .container > h1 {\n  color: rgba(255, 0, 0, 0.24);\n  font-size: 3.5em;\n  font-family: monospace;\n  text-shadow: 4px 4px 0px rgba(0, 255, 0, 0.56);\n}\nbody .container input#url {\n  box-sizing: border-box;\n  width: 100%;\n  font-size: 1em;\n  line-height: 1.1em;\n  padding: 6px 0 6px 6px;\n  border: 0 solid #aaa;\n  border-bottom-width: 2px;\n  outline: 0;\n  margin: 0.3em 0;\n}\nbody .container input#url + .desc {\n  font-size: .8em;\n  text-align: right;\n}\nbody .container input#url.valid {\n  border-color: #080;\n  color: #080;\n}\nbody .container input#url.valid + .desc:after {\n  content: '\\2714';\n  color: #080;\n}\nbody .container input#url.invalid {\n  border-color: #b44;\n  color: #b44;\n}\nbody .container input#url.invalid + .desc:after {\n  content: 'invalid commit URL';\n  color: #b44;\n}\nbody .container #content {\n  margin-top: 1em;\n}\nbody .container #content article.file {\n  margin: 2em 0;\n  overflow: hidden;\n  background: #fff;\n}\nbody .container #content article.file > header {\n  margin: 0;\n}\nbody .container #content article.file > header h1 {\n  padding: .5em .5em 0;\n  font-size: .9em;\n  margin: 0 0 0.5em;\n  line-height: 1.6em;\n  font-weight: bold;\n  border-bottom: dashed 2px #ccc;\n  display: inline-block;\n}\nbody .container #content article.file > main ul li.chunk {\n  margin: 0 0 -1px;\n  overflow-x: auto;\n  position: relative;\n}\nbody .container #content article.file > main ul li.chunk .ui {\n  position: absolute;\n  top: 1.5em;\n  right: .5em;\n  z-index: 1;\n  background: #ddd;\n  border-radius: 9999px;\n  line-height: 1.2em;\n  box-shadow: 2px 2px 2px -1px #bbb inset;\n  padding: 2px 0;\n  overflow: hidden;\n}\nbody .container #content article.file > main ul li.chunk .ui input[type=radio] {\n  position: relative;\n  width: 1em;\n  margin: 0 .7em;\n  vertical-align: middle;\n}\nbody .container #content article.file > main ul li.chunk .ui input[type=radio]:after {\n  content: attr(aria-label);\n  display: block;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  margin: -0.5em 0 0 -0.5em;\n  border-radius: 50%;\n  width: 1em;\n  height: 1em;\n  line-height: 1em;\n  vertical-align: middle;\n  text-align: center;\n  font-size: 1.7em;\n  border: 0;\n  color: #777;\n  background: #ddd;\n}\nbody .container #content article.file > main ul li.chunk .ui input[type=radio]:checked:after {\n  background: #fff;\n}\nbody .container #content article.file > main ul li.chunk code {\n  display: table;\n  background: #f6f6f6;\n  min-width: 100%;\n  line-height: 1.5em;\n  position: relative;\n}\nbody .container #content article.file > main ul li.chunk code:before {\n  position: absolute;\n  top: 0;\n  width: 100%;\n  content: '';\n  display: block;\n  height: 1.5em;\n  background: linear-gradient(-30deg, rgba(0, 0, 0, 0) 0, rgba(0, 0, 0, 0) 50%, #fff 50%, #fff 100%), linear-gradient(30deg, rgba(0, 0, 0, 0) 0, rgba(0, 0, 0, 0) 50%, #fff 50%, #fff 100%);\n  background-size: 2em 1.5em;\n}\nbody .container #content article.file > main ul li.chunk code:after {\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  content: '';\n  display: block;\n  background: #ddd;\n  height: 1.5em;\n  background: linear-gradient(-30deg, #fff 0, #fff 50%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 100%), linear-gradient(30deg, #fff 0, #fff 50%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 100%);\n  background-size: 2em 1.5em;\n  background-position: 1em 0;\n}\nbody .container #content article.file > main ul li.chunk code .row {\n  display: table-row;\n}\nbody .container #content article.file > main ul li.chunk code .row .cell {\n  display: table-cell;\n  white-space: pre;\n}\nbody .container #content article.file > main ul li.chunk code .row .cell.number {\n  width: 2em;\n}\nbody .container #content article.file > main ul li.chunk code .row .cell.number:before,\nbody .container #content article.file > main ul li.chunk code .row .cell.number:after {\n  content: ' ';\n  display: inline-block;\n  width: 2em;\n  color: #fafafa;\n  text-align: right;\n  padding: 0 .25em;\n  background: rgba(0, 0, 0, 0.3);\n  border-right: solid 1px rgba(0, 0, 0, 0.1);\n}\nbody .container #content article.file > main ul li.chunk code .row .cell.line {\n  padding: 0 0 0 1em;\n  color: #555;\n}\nbody .container #content article.file > main ul li.chunk code .row:first-child .number:before,\nbody .container #content article.file > main ul li.chunk code .row:first-child .number:after {\n  padding-top: 1.4em;\n}\nbody .container #content article.file > main ul li.chunk code .row:last-child .number:before,\nbody .container #content article.file > main ul li.chunk code .row:last-child .number:after {\n  padding-bottom: 1.4em;\n}\nbody .container #content article.file > main ul li.chunk code .row.normal .number:before {\n  content: attr(data-line-number1);\n}\nbody .container #content article.file > main ul li.chunk code .row.normal .number:after {\n  content: attr(data-line-number2);\n}\nbody .container #content article.file > main ul li.chunk code .row.normal .line:before {\n  content: ' ';\n}\nbody .container #content article.file > main ul li.chunk code .row.add {\n  background: #e3ffe3;\n}\nbody .container #content article.file > main ul li.chunk code .row.add .number:after {\n  color: #aea;\n  content: attr(data-line-number);\n}\nbody .container #content article.file > main ul li.chunk code .row.add .line:before {\n  content: '+';\n  color: #0d0;\n}\nbody .container #content article.file > main ul li.chunk code .row.del {\n  background: #ffe3e3;\n}\nbody .container #content article.file > main ul li.chunk code .row.del .number:before {\n  color: #fdd;\n  content: attr(data-line-number);\n}\nbody .container #content article.file > main ul li.chunk code .row.del .line:before {\n  content: '-';\n  color: #d00;\n}\nbody .container #content article.file > main ul li.chunk[data-status=before] code .row.add,\nbody .container #content article.file > main ul li.chunk[data-status=before] code .row .cell.number:after {\n  display: none;\n}\nbody .container #content article.file > main ul li.chunk[data-status=after] code .row.del,\nbody .container #content article.file > main ul li.chunk[data-status=after] code .row .cell.number:before {\n  display: none;\n}\n", ""]);
...
var Handlebars = __webpack_require__(322);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <article class=\"file\">\n        <header>\n            <h1>"
    ...
    + "</h1>\n        </header>\n        <main>\n            <ul class=\"chunks\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.chunks : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "            </ul>\n        </main>\n    </article>\n";
},"2":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "                    <li class=\"chunk\">\n                        <div class=\"ui\">\n                            <input type=\"radio\" name=\"mode"
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    + "\" aria-label=\"&larr;\" value=\"before\">\n                            <input type=\"radio\" name=\"mode"
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    + "\" aria-label=\"&rarr;\" value=\"after\">\n                            <input type=\"radio\" name=\"mode"
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    + "\" aria-label=\"&harr;\" value=\"both\" checked>\n                        </div>\n                        <code>\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.changes : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                        </code>\n                    </li>\n";
  ...
  return "                                <div class=\"row "
    ...
    + "\">\n                                    <div class=\"cell number\" data-line-number=\""
    + alias4(((helper = (helper = helpers.ln || (depth0 != null ? depth0.ln : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"ln","hash":{},"data":data}) : helper)))
    + "\" data-line-number1=\""
    + alias4(((helper = (helper = helpers.ln1 || (depth0 != null ? depth0.ln1 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"ln1","hash":{},"data":data}) : helper)))
    + "\" data-line-number2=\""
    + alias4(((helper = (helper = helpers.ln2 || (depth0 != null ? depth0.ln2 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"ln2","hash":{},"data":data}) : helper)))
    + "\"></div>\n                                    <div class=\"cell line\">"
...
var _handlebarsBase = __webpack_require__(118);
...
var _handlebarsSafeString = __webpack_require__(321);
...
var _handlebarsNoConflict = __webpack_require__(319);
...
var _decoratorsInline = __webpack_require__(309);
...
var _helpersBlockHelperMissing = __webpack_require__(311);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(312);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(313);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(314);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(315);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(316);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(317);
...
var _base = __webpack_require__(118);
...
module.exports = "<!DOCTYPE html>\n<html lang=\"ko\">\n\n<head>\n    <meta charset=\"UTF-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    <meta http-equiv=\"X-UA-Compatible\" content=\"ie=edge\">\n    <title>Embeddable Git Diff</title>\n</head>\n\n<body>\n    <div class=\"container\">\n        <h1>Embeddable Git Diff</h1>\n        <label for=\"url\">paste Github commit url here</label>\n        <input type=\"url\" id=\"url\" placeholder=\"https://github.com/{userId}/{userRepository}/commit/{SHA...}\">\n        <div class=\"desc\"></div>\n\n        <div id=\"content\"></div>\n    </div>\n</body>\n\n</html>"
